...
function transference() {
    ...
    inquirer.prompt([{
        ...
        inquirer.prompt([{
            name: 'accountDestiny',
            message: 'Para qual conta deseja realizar a transferência?'
            ...
            inquirer.prompt([{
                ...
                accountDestinyData = getAccount(accountDestiny)
                ...
                accountData.balance = parseFloat(accountData.balance) - parseFloat(amount)
                accountDestinyData.balance = parseFloat(accountDestinyData.balance) + parseFloat(amount)
                ...
                fs.writeFileSync(
                    `accounts/${accountDestiny}.json`,
                    JSON.stringify(accountDestinyData),
                    function (err) {
                        console.log(err)
                    }
                )
